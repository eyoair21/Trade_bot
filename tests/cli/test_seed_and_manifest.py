...
class TestSeedReproducibility:
    ...
    def test_different_seed_produces_different_results(
        ...
        metrics_differ = (
            results_a["avg_oos_return_pct"] != results_b["avg_oos_return_pct"]
            or results_a["total_oos_trades"] != results_b["total_oos_trades"]
        )
        
        # If metrics are identical, that's OK (can happen with simple strategies)
        # The important thing is that seeds are different
